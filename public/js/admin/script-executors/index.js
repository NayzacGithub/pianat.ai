(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["/js/admin/script-executors/index"],{

/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js&":
/*!**************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js& ***!
  \**************************************************************************************************************************************************************************************/
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mounted: function mounted() {
    ...
    var userId = _.get(document.querySelector('meta[name="user-id"]'), "content");

    if (userId) {
      window.Echo["private"]("ProcessMaker.Models.User.".concat(userId)).listen(".BuildScriptExecutor", function (event) {
        var status = event.status;
        _this2.status = status;

        switch (status) {
          case "starting":
            _this2.pidFile = event.output;
            _this2.exitCode = 0;
            break;

          case "done":
            _this2.pidFile = null;
            _this2.exitCode = event.output;
            break;

          case "error":
            _this2.output(event.output);
  ...
  watch: {
    commandOutput: function commandOutput() {
      this.scrollToBottom();
    }
  },
  computed: {
    ...
    languagesSelect: function languagesSelect() {
      return [{
        value: null,
        text: this.$t("Select a language")
      }].concat(_toConsumableArray(this.languages));
    },
    initDockerfile: function initDockerfile() {
      var _this3 = this;

      var content = "";

      if (this.formData.language) {
        content = _.get(this.languages.find(function (l) {
          return l.value === _this3.formData.language;
        }), "initDockerfile", "");
      }
  ...
  methods: {
    deleteExecutor: function deleteExecutor(row) {
      var _this4 = this;

      ProcessMaker.confirmModal(this.$t("Caution!"), this.$t("Are you sure you want to delete {{item}}?", {
        item: row.title
      }), "", function () {
        var path = "/script-executors/" + row.id;
        ProcessMaker.apiClient["delete"](path).then(function (result) {
          _this4.status = _.get(result, "data.status", "error");

          if (_this4.status === "done") {
            _this4.fetch();

            _this4.$refs.edit.hide();
          }
        })["catch"](function (e) {
    ...
    doNotHideIfRunning: function doNotHideIfRunning(e) {
      if (this.isRunning) {
        e.preventDefault();
      }
    },
    output: function output(text) {
    ...
    scrollToBottom: function scrollToBottom() {
      ...
      if (this.$refs.pre) {
        ...
        setTimeout(function () {
          _this6.$refs.pre.scrollTop = _this6.$refs.pre.scrollHeight;
        }, 5);
      }
    },
    save: function save() {
      ...
      if (this.formData.id) {
        var path = "/script-executors/" + this.formData.id;
        ProcessMaker.apiClient.put(path, this.formData).then(function (result) {
          _this7.status = _.get(result, "data.status", "error");
        })["catch"](function (e) {
          _this7.setErrors(e);
        });
      } else {
        var _path = "/script-executors";
        ProcessMaker.apiClient.post(_path, this.formData).then(function (result) {
          _this7.status = _.get(result, "data.status", "error");

          if (_this7.status === "started") {
            _this7.formData.id = result.data.id;

            _this7.fetch(); // refresh the table (beneath the modal)
    ...
    resetProcessInfo: function resetProcessInfo() {
      this.commandOutput = "";
      this.exitCode = 0;
      this.pidFile = null;
    },
    loadLanguages: function loadLanguages() {
      ...
      ProcessMaker.apiClient.get("/script-executors/available-languages").then(function (result) {
        _this8.languages = result.data.languages;
      });
    },
    fetch: function fetch() {
      ...
      ProcessMaker.apiClient.get("script-executors?page=" + this.page + "&per_page=" + this.perPage + "&filter=" + this.filter + "&order_by=" + this.orderBy + "&order_direction=" + this.orderDirection).then(function (response) {
        _this9.data = _this9.transform(response.data);
...
/***/ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&":
/*!*********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader??ref--8-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--8-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& ***!
  \*********************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "\n.command-output[data-v-753ed982] {\n  font-size: 0.7em;\n  height: 200px;\n}\n.dockerfile[data-v-753ed982] {\n  height: 300px;\n}\n.error[data-v-753ed982] {\n  border-color: red !important;\n}\n", ""]);
...
/***/ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&":
/*!*************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/style-loader!./node_modules/css-loader??ref--8-1!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src??ref--8-2!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {


var content = __webpack_require__(/*! !../../../../node_modules/css-loader??ref--8-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--8-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& */ "./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true&":
/*!******************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true& ***!
  \******************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  attrs: {
                    "aria-label": _vm.$t("Add New Script Executor"),
                    type: "button",
                  },
                  on: {
                    click: function ($event) {
                ...
                [
                  ...
                  _vm._v(" " + _vm._s(_vm.$t("Script Executor")) + "\n      "),
                ]
              ),
            ],
            1
      ...
      _c(
        ...
        [
                        ...
                        [
                          _c(
                            "b-btn",
                            {
                              ...
                              attrs: { variant: "link", title: _vm.$t("Edit") },
                              on: {
                                click: function ($event) {
                          ...
                          _c(
                            "b-btn",
                            {
                              ...
                              on: {
                                click: function ($event) {
                                  return _vm.deleteExecutor(props.rowData)
                                },
                              },
                            },
                            [
          ...
          _c("pagination", {
            ref: "pagination",
            attrs: {
              single: _vm.$t("Script Executor"),
              plural: _vm.$t("Script Executors"),
      ...
      _c(
                ...
                return [
                  ...
                  _vm.showSave
                    ? _c(
                        ...
                        [
                          _vm.formData.id
                            ? [_vm._v(_vm._s(_vm.$t("Save And Rebuild")))]
                            : [_vm._v(_vm._s(_vm.$t("Save And Build")))],
                        ],
                        2
                      )
                    : _vm._e(),
        ...
        [
                              ...
                              _c(
                                "b-form-group",
                                {
                                  attrs: {
                                    ...
                                    state: !_vm.getError("language"),
                                    "invalid-feedback":
                                      _vm.getError("language") || "",
                                  },
                                },
                                [
                                  _c("b-form-select", {
          ...
          _c("p", { staticClass: "mb-0" }, [
            _vm._v(_vm._s(_vm.$t("Docker file"))),
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "d-flex flex-row mb-1" }, [
            _c("div", { staticClass: "mr-1" }, [
              _c(
                "a",
                {
                  attrs: {
                    "aria-expanded": _vm.showDockerfile ? "true" : "false",
                    title: _vm.$t(
                      "Display contents of docker file that will be prepended to your customizations below."
                    ),
                  },
                  on: {
                    click: function ($event) {
                      _vm.showDockerfile = !_vm.showDockerfile
                    },
                  },
                },
                [
                  _c("i", {
                    staticClass: "fa",
                    class: {
                      "fa-chevron-right": !_vm.showDockerfile,
                      "fa-chevron-down": _vm.showDockerfile,
                    },
            ...
            _c(
              ...
              [
                _c(
                  ...
                  [
                    _vm._v(_vm._s(_vm.initDockerfile.split("\n")[0]) + " "),
                    !_vm.showDockerfile ? [_vm._v("...")] : _vm._e(),
                  ],
                  2
                ),
                _vm._v(" "),
                _c(
                  "b-collapse",
                  {
                    attrs: {
                      id: "dockerfile",
                      "aria-hidden": _vm.showDockerfile ? "false" : "true",
                    },
                    model: {
                      value: _vm.showDockerfile,
                      callback: function ($$v) {
                        _vm.showDockerfile = $$v
                      },
                      expression: "showDockerfile",
                    },
                  },
                  [
                    _c("pre", [
          ...
          _vm._v(" "),
          _c("b-form-textarea", {
            staticClass: "mb-3 dockerfile",
            attrs: { disabled: _vm.isRunning },
            model: {
              value: _vm.formData.config,
              callback: function ($$v) {
                _vm.$set(_vm.formData, "config", $$v)
              },
              expression: "formData.config",
            },
          }),
          _vm._v(" "),
          _vm.commandOutput !== "" || _vm.isRunning
            ? _c("div", [
                _c("p", [
                  _vm._v(
                    "\n        " +
                      _vm._s(_vm.$t("Build Command Output")) +
                      "\n        "
                  ),
                  _vm.isRunning
                ...
                _c(
                  ...
                  {
                    ref: "pre",
                    staticClass: "border command-output pre-scrollable",
                    class: { error: _vm.exitCode !== 0 },
                  },
                  [_vm._v(_vm._s(_vm.commandOutput))]
                ),
              ])
            : _vm._e(),
          _vm._v(" "),
                  ...
                  ? _c("p", [
                      _vm._v(
                        "\n        " +
                          _vm._s(
                            _vm.$t(
                              "Executor Successfully Built. You can now close this window. "
                            )
                          ) +
                          "\n      "
                      ),
                      ...
                      [
                        _vm._v(
                          "\n        " +
                            _vm._s(
                              _vm.$t(
                                "Error Building Executor. See Output Above."
                              )
                            ) +
                            "\n      "
                        ),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true& */ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true&");
/* harmony import */ var _ScriptExecutors_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ScriptExecutors.vue?vue&type=script&lang=js& */ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& */ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _ScriptExecutors_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "753ed982",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/admin/script-executors/ScriptExecutors.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js&":
/*!******************************************************************************************!*\
  !*** ./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib??ref--4-0!../../../../node_modules/vue-loader/lib??vue-loader-options!./ScriptExecutors.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport */ /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_ref_4_0_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&":
/*!**************************************************************************************************************************!*\
  !*** ./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& ***!
  \**************************************************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_8_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/style-loader!../../../../node_modules/css-loader??ref--8-1!../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../node_modules/postcss-loader/src??ref--8-2!../../../../node_modules/vue-loader/lib??vue-loader-options!./ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css& */ "./node_modules/style-loader/index.js!./node_modules/css-loader/index.js?!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/src/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=style&index=0&id=753ed982&scoped=true&lang=css&");
/* harmony import */ var _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_8_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_8_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_8_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_style_loader_index_js_node_modules_css_loader_index_js_ref_8_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_2_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_style_index_0_id_753ed982_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));


/***/ }),

/***/ "./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true&":
/*!************************************************************************************************************!*\
  !*** ./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true& ***!
  \************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../node_modules/vue-loader/lib??vue-loader-options!./ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/admin/script-executors/ScriptExecutors.vue?vue&type=template&id=753ed982&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_ScriptExecutors_vue_vue_type_template_id_753ed982_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ScriptExecutors__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ScriptExecutors */ "./resources/js/admin/script-executors/ScriptExecutors.vue");

new Vue({
  el: '#script-executors',
  components: {
    ScriptExecutors: _ScriptExecutors__WEBPACK_IMPORTED_MODULE_0__["default"]
  }
});
...
/***/ 13:
/*!************************************************************!*\
  !*** multi ./resources/js/admin/script-executors/index.js ***!
  \************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /var/www/pianat.ai/resources/js/admin/script-executors/index.js */"./resources/js/admin/script-executors/index.js");
