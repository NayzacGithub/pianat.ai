<div id="users-listing">
    <div id="search-bar" class="search mb-3" vcloak>
        <div class="d-flex flex-column flex-md-row gap-3">
            <div class="flex-grow-1 mr-2">
                <div id="search" class="mb-3 mb-md-0">
                    <div class="input-group w-100 ">
                        <input id="search-box" v-model="filter" class="form-control" placeholder="{{ __('Search') }}"
            ...
            @can('create-users')
                <div class="d-flex ml-2 flex-column flex-md-row">
    ...
    <div class="container-fluid">
        <users-listing ref="listing" :filter="filter"
            :permission="{{ \Auth::user()->hasPermissionsFor('users') }}" v-on:reload="reload">
        </users-listing>
    </div>
    @can('create-users')
        <add-user-modal ref="addUserModal" title="{{ __('Create User') }}">
            <template v-slot:default>
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('username', null, [
                        ...
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.username}',
                        'autocomplete' => 'off',
                        'required',
                        'aria-required' => 'true',
                    ]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('firstname', null, [
                        ...
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.firstname}',
                        'required',
                        'aria-required' => 'true',
                    ]) !!}
                    <div class="invalid-feedback" role="alert" v-for="firstname in config.addError.firstname">
                        @{{ firstname }}</div>
                </div>
                <div class="form-group">
                    ...
                    {!! Form::text('lastname', null, [
                        ...
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.lastname}',
                        'required',
                        'aria-required' => 'true',
                    ]) !!}
                    <div class="invalid-feedback" role="alert" v-for="lastname in config.addError.lastname">
                        @{{ lastname }}</div>
                </div>
                <div class="form-group">
                    ...
                    {!! Form::text('title', null, [
                        ...
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.title}',
                    ]) !!}
                    <div class="invalid-feedback" role="alert" v-for="title in config.addError.title">
                        @{{ title }}</div>
                </div>
                <div class="form-group">
                    ...
                    {!! Form::select(
                        'status',
                        [null => __('Select')] + ['ACTIVE' => __('Active'), 'INACTIVE' => __('Inactive')],
                        'Active',
                        [
                            'class' => 'form-control',
                    ...
                    <div class="invalid-feedback" role="alert" v-for="status in config.addError.status">
                        @{{ status }}</div>
                </div>
                <div class="form-group">
                    ...
                    {!! Form::email('email', null, [
                        ...
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.email}',
                        'autocomplete' => 'off',
                        'required',
                        'aria-required' => 'true',
                    ]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::password('confpassword', [
                        'class' => 'form-control',
                        'v-model' => 'config.confpassword',
                        'v-bind:class' => '{\'form-control\':true, \'is-invalid\':config.addError.password}',
                        'autocomplete' => 'new-password',
                        'required',
                        'aria-required' => 'true',
                    ]) !!}
                    <div class="invalid-feedback" role="alert" v-for="password in config.addError.password">
                        @{{ password }}</div>
                </div>
            </template>
            ...
            <template v-slot:modal-footer>
                ...
                <button type="button" class="btn btn-secondary" @click="onSubmit" id="saveUser"
