                ...
                <div class="card w-100">
                    <div class="card-body">
                        <div class="col-lg-6 ps-lg-4 my-5 text-center text-lg-start">
                            <h3 class="display-6 text-secondary">{{ emptyText() }}</h3>
            ...
            <div v-else>
                <div class="icon-container">
                    <div v-if="iconType() === 'gear'">
                        <svg class="lds-gear" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 100 100"
                            preserveAspectRatio="xMidYMid">
                            <g transform="translate(50 50)">
                                <g transform="rotate(248.825)">
                                    <animateTransform attributeName="transform" type="rotate" values="0;360"
                                        keyTimes="0;1" dur="4.7s" repeatCount="indefinite"></animateTransform>
                                    <path
