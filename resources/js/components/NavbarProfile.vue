<template>
  <div id="userMenu">
    <div id="profileMenu">
      <avatar-image id="avatarMenu" class-container="d-flex" size="40" class-image="m-0" :input-data="information"
        hide-name="true" popover ref="userMenuButton"></avatar-image>
    </div>
    ...
    <b-popover container="#userMenu" :target="getTarget" placement="bottomleft" offset="3" triggers="click blur"
      ...
      <ul class="list-group list-group-flush px-1">
        ...
        <li class="list-group-item px-2">
          <a href="https://processmaker.gitbook.io/processmaker/" role="menuitem" :aria-label="$t('Documentation')"
            target="_blank">
